...
SECRET_KEY = 'jnrv$m)n3ewlczfa7x&0r)%p1yl8nlp5)abphv@@t@$u3430=q'
...
#ESTO ESTA CARPETA SE DEBE IGNORAR EN EL GITIGNORE
STATIC_URL = '/static/'
STATICFILES_DIRS = (
...
#Esto hay que hacerlo para el login con clases
